...
zones[xi.zone.AYDEEWA_SUBTERRANE] =
{
    text =
    {
        ...
        MUSHROOM_NEEDS_FERTILIZER     = 7426, -- There is a mushroom is growing here. It might grow larger if it had some fertilizer.
        MUSHROOM_IS_GROWING_HERE      = 7427, -- There is a mushroom is growing here.
