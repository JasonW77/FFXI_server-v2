...
zones[xi.zone.YHOATOR_JUNGLE] =
{
    text =
    {
        ...
        TREE_CHECK                    = 7702,  -- The hole in this tree is filled with a sweet-smelling liquid.
        TREE_FULL                     = 7703,  -- Your wine barrel is already full.
        CHILL_RUNS_DOWN               = 7704,  -- A chill runs down your spine...
        WATER_HOLE                    = 7706,  -- There is an Opo-opo drinking well here. It seems they feast here, too.
        FAINT_CRY                     = 7707,  -- You hear the cry of a famished Opo-opo!
        PAMAMAS                       = 7710,  -- You might be able to draw an Opo-opo here if you had more pamamas.
        ...
        TIME_ELAPSED                  = 7804,  -- Time elapsed: <number> [hour/hours] (Vana'diel time) <number> [minute/minutes] and <number> [second/seconds] (Earth time)
        PLAYER_OBTAINS_ITEM           = 7836,  -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM         = 7837,  -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM      = 7838,  -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP          = 7839,  -- You already possess that temporary item.
        NO_COMBINATION                = 7844,  -- You were unable to enter a combination.
        UNITY_WANTED_BATTLE_INTERACT  = 7906,  -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
        REGIME_REGISTERED             = 10022, -- New training regime registered!
        COMMON_SENSE_SURVIVAL         = 11141, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
    },
    mob =
    {
